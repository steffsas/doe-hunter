...
func TestKafkaEventConsumer_Consume(t *testing.T) {
	...
	t.Run("valid consume", func(t *testing.T) {
		...
		kc := &k.KafkaEventConsumer{
			Consumer:       mkc,
			StorageHandler: &storage.EmptyStorageHandler{},
			ProcessHandler: &k.EmptyProcessHandler{},

			Timeout: 100 * time.Millisecond,

			Config: &k.KafkaConsumerConfig{
...
func TestKafkaEventConsumer_NewConsumer(t *testing.T) {
	...
	t.Run("no process handler", func(t *testing.T) {
		t.Parallel()
		kc, err := k.NewKafkaEventConsumer(nil, nil, &storage.EmptyStorageHandler{})
	...
	t.Run("no storage handler", func(t *testing.T) {
		t.Parallel()
		kc, err := k.NewKafkaEventConsumer(nil, &k.EmptyProcessHandler{}, nil)
	...
	t.Run("nil consumer group config", func(t *testing.T) {
		t.Parallel()
		kc, err := k.NewKafkaEventConsumer(&k.KafkaConsumerConfig{
			Server: "localhost:9092",
			Topic:  "test-topic",
		}, &k.EmptyProcessHandler{}, &storage.EmptyStorageHandler{})
